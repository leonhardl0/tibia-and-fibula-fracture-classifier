...
def main():
    pasta_base_dataset = "C:/Users/Leo/Downloads/tibia-and-fibula-fracture-classifier-main" # <-- mude aqui
    ...
    X_treino_proc, X_teste_proc, y_treino_one_hot, y_teste_one_hot, label_encoder, num_classes, input_shape = pre_processar_dados(
